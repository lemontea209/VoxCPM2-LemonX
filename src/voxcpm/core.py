# =============================================================================
# NOTICE: This file has been modified by Lemon-X in 2026 for the
# VoxCPM2 integrated distribution (Lemon-X edition).
#
# Original work: VoxCPM, Copyright (c) OpenBMB, licensed under the
# Apache License, Version 2.0. Full licence text: win-unpacked/python/LICENSE
#
# Change made: load the ZipEnhancer denoiser from the model directory bundled with this distribution instead of downloading it at runtime.
#
# This modification notice is provided under Section 4(b) of the
...
class VoxCPM:
    def __init__(
        ...
        zipenhancer_model_path: str | None = "./models/speech_zipenhancer_ans_multiloss_16k_base",

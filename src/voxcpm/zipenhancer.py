...
#
# Change made: default the ZipEnhancer model path to the local bundled model directory.
#
...
class ZipEnhancer:
    ...
    def __init__(self, model_path: str = "./models/speech_zipenhancer_ans_multiloss_16k_base"):
        """
